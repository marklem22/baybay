...
export const BUILT_IN_THEME_PRESETS_BY_ID: Record<string, BuiltInThemePreset> =
  BUILT_IN_THEME_PRESETS.reduce<Record<string, BuiltInThemePreset>>((acc, preset) => {
