...
import { Archive as ArchiveIcon, FileText, Printer } from "lucide-react";
          ...
          <section>
            ...
            {isLoading ? (
              ...
              <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-card)] p-8 text-center text-[var(--text-secondary)]">
                <FileText className="mx-auto mb-3" size={32} strokeWidth={1.5} />
      ...
      {activeTab === "archived" && (
        <section>
          ...
          {isLoadingArchive ? (
            ...
            <div className="rounded-xl border border-[var(--border)] bg-[var(--bg-card)] p-8 text-center text-[var(--text-secondary)]">
              <ArchiveIcon className="mx-auto mb-3" size={32} strokeWidth={1.5} />
